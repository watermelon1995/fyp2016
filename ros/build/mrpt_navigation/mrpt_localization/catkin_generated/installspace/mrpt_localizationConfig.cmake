...
if("FALSE" STREQUAL "TRUE")
  set(mrpt_localization_SOURCE_PREFIX /home/kin/fyp2016/ros/src/mrpt_navigation/mrpt_localization)
  set(mrpt_localization_DEVEL_PREFIX /home/kin/fyp2016/ros/devel)
  ...
  set(mrpt_localization_INSTALL_PREFIX /home/kin/fyp2016/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mrpt_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Markus Bader <markus.bader@tuwien.ac.at>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mrpt_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kin/fyp2016/ros/install/${idir}'.  Ask the maintainer 'Markus Bader <markus.bader@tuwien.ac.at>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mrpt_localization_dep}_FOUND)
      find_package(${mrpt_localization_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mrpt_localization_dep} REQUIRED ${depend_list})
  endif()
